...
def process_report_2(onboarding_df, deposit_df, ticket_df, scan_df):
    ...
    try:
        ...
        deposit_tx_type_col = find_column(deposit_df, ['Transaction Type', 'transaction_type', 'TransactionType', 'Type', 'transaction type', 'txn_type', 'TXN_TYPE'])
        ticket_tx_type_col = find_column(ticket_df, ['Transaction Type', 'transaction_type', 'TransactionType', 'Type', 'transaction type', 'txn_type', 'TXN_TYPE'])
        scan_tx_type_col = find_column(scan_df, ['Transaction Type', 'transaction_type', 'TransactionType', 'Type', 'transaction type', 'txn_type', 'TXN_TYPE'])
        
        # Find customer mobile columns
        deposit_customer_col = find_column(deposit_df, ['User Identifier', 'user_id', 'UserIdentifier', 'Customer Mobile', 'customer_mobile', 'Mobile', 'USER_ID', 'User ID'])
        ticket_customer_col = find_column(ticket_df, ['User Identifier', 'user_id', 'UserIdentifier', 'Customer Mobile', 'customer_mobile', 'Mobile', 'USER_ID', 'User ID', 'created_by'])
        scan_customer_col = find_column(scan_df, ['User Identifier', 'user_id', 'UserIdentifier', 'Customer Mobile', 'customer_mobile', 'Mobile', 'USER_ID', 'User ID', 'Created By'])
